...
class EventBus(QObject):
    ...
    number_area_pick_requested = Signal()
    ...
    step_property_variable_changed = Signal(str, str)
    macro_variable_added = Signal()
    macro_variable_changed = Signal(str, str, str)
    macro_variable_renamed = Signal(str, str)
    macro_variable_deleted = Signal(str)
