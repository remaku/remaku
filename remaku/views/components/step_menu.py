...
def step_type_items() -> list[dict[str, str]]:
    return [
        ...
        {"id": "wait_number", "label": QCoreApplication.translate("StepMenu", "Wait Number")},
        ...
        {"id": "repeat_until_number", "label": QCoreApplication.translate("StepMenu", "Repeat Until Number")},
        {"id": "if_image", "label": QCoreApplication.translate("StepMenu", "If Image")},
        {"id": "if_number", "label": QCoreApplication.translate("StepMenu", "If Number")},
